...
class election_setup_4 extends StatefulWidget {
  const election_setup_4({Key? key}) : super(key: key);

  @override
  State<election_setup_4> createState() => _election_setup_4State();
}

class _election_setup_4State extends State<election_setup_4> {
  ///variables end
  ///variables to set
  String name1candi = "";
  String name2candi = "";
  ...
  Future<void> SendMailtoAll(
      String elname, String cn1, String cn2, String cn3, String cn4) async {
