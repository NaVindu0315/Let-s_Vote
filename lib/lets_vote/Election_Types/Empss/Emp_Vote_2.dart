...
class Emp_Vote_2 extends StatefulWidget {
  const Emp_Vote_2({Key? key}) : super(key: key);

  @override
  State<Emp_Vote_2> createState() => _Emp_Vote_2State();
}

class _Emp_Vote_2State extends State<Emp_Vote_2> {
  Client? httpClient;
