...
class Emp_Vote_3 extends StatefulWidget {
  const Emp_Vote_3({Key? key}) : super(key: key);

  @override
  State<Emp_Vote_3> createState() => _Emp_Vote_3State();
}

class _Emp_Vote_3State extends State<Emp_Vote_3> {
  Client? httpClient;
