...
class Mng_new_Election_results extends StatefulWidget {
  const Mng_new_Election_results({Key? key}) : super(key: key);

  @override
  State<Mng_new_Election_results> createState() =>
      _Mng_new_Election_resultsState();
}

class _Mng_new_Election_resultsState extends State<Mng_new_Election_results> {
