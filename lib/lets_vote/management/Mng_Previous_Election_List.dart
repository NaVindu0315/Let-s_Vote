...
void main() async {
  ...
  runApp(Mng_previous_election_List());
}

class Mng_previous_election_List extends StatefulWidget {
  @override
  suc_attempt createState() => suc_attempt();
}

class suc_attempt extends State<Mng_previous_election_List> {
  final FirebaseFirestore firestore = FirebaseFirestore.instance;

  final CollectionReference postsRef =
      FirebaseFirestore.instance.collection('electionss');
