...
class Mng_Election_Results extends StatefulWidget {
  const Mng_Election_Results({Key? key}) : super(key: key);

  @override
  State<Mng_Election_Results> createState() => _Mng_Election_ResultsState();
}

class _Mng_Election_ResultsState extends State<Mng_Election_Results> {
  Client? httpClient;
