...
class Mng_Login extends StatefulWidget {
  @override
  State<Mng_Login> createState() => _Mng_LoginState();
}

class _Mng_LoginState extends State<Mng_Login> {
              ...
              Column(
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Text(
                      'Manager Login', // Add this new Text widget
                      style: TextStyle(
                        fontSize: 20,
