...
class detailed_employee extends StatefulWidget {
  final String selectedusser;

  detailed_employee({required this.selectedusser});

  @override
  _detailed_employeeState createState() => _detailed_employeeState();
}

class _detailed_employeeState extends State<detailed_employee> {
