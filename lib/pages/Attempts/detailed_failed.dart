...
class Detailed_Fails extends StatefulWidget {
  final String failedid;

  Detailed_Fails({required this.failedid});

  @override
  _Detailed_FailsState createState() => _Detailed_FailsState();
}

class _Detailed_FailsState extends State<Detailed_Fails> {
  ...
  void initState() {
    super.initState();
    selectedattempt = widget.failedid;
    getcurrentuser();
  }
