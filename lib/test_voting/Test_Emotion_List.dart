...
void main() async {
  ...
  runApp(Test_Emotion_List());
}

class Test_Emotion_List extends StatefulWidget {
  @override
  suc_attempt createState() => suc_attempt();
}

class suc_attempt extends State<Test_Emotion_List> {
  final FirebaseFirestore firestore = FirebaseFirestore.instance;

  final CollectionReference postsRef =
      FirebaseFirestore.instance.collection('test_emotions');
